...
To get structured package info, run: `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./{DIR_WORKFLOW}/scripts/get_context.py --mode packages`
