...
def _get_task_status(trellis_dir: Path, input_data: dict) -> str:
    ...
    if not active.task_path:
        return (
            ...
            "to clarify requirements and create a task via `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py create`.\n"
    ...
    if active.stale or not task_dir.is_dir():
        return (
            ...
            f"Source: {active.source}\n"
            f"Next-Action: Run `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py finish` to clear the stale pointer, "
    ...
    if task_status == "completed":
        return (
            ...
            f"then archive with `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py archive {task_dir.name}`."
        )
    ...
    if implement_jsonl.is_file() and not _has_curated_jsonl_entry(implement_jsonl):
        return (
            ...
            "`C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/get_context.py --mode packages` to list available specs, "
            "then edit the jsonl files or use `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py add-context`. "
