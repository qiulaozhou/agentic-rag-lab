...
2. **Confirm the current active task**: run `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py current --source`.
