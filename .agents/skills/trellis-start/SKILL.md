...
- **Active task + `prd.md` exists** → Phase 2 step 2.1. Load the step detail:
  ```bash
  C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/get_context.py --mode phase --step 2.1 --platform codex
  ```
