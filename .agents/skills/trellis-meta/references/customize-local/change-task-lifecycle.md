...
hooks:
  after_create:
    - "C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py create"
  after_start:
    - "C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py start"
  after_finish:
    - "C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py finish"
  after_archive:
    - "C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe .trellis/scripts/hooks/my_sync.py archive"
```
...
1. Confirm the current task with `C:\Users\admin\AppData\Roaming\uv\python\cpython-3.12.12-windows-x86_64-none\python.exe ./.trellis/scripts/task.py current --source`.
